...
import mtgJsonSetWOE from '../../mtgjson/AllSetFiles/WOE.json' assert { type: 'json' };
import { Set } from '../../src/mtgjson-types.ts';
import { setSizeRarity } from './_helpers.ts';
import { ComputedValue } from '../computed.ts';

export const run10 = () => {
    const sets: Set[] = [mtgJsonSetVOW.data, mtgJsonSetNEO.data, mtgJsonSetSNC.data, mtgJsonSetDMU.data, mtgJsonSetBRO.data, mtgJsonSetONE.data, mtgJsonSetMOM.data, mtgJsonSetMAT.data, mtgJsonSetWOE.data];
