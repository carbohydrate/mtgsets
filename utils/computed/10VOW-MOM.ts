...
export const run10 = () => {
    const sets: Set[] = [mtgJsonSetVOW.data, mtgJsonSetNEO.data, mtgJsonSetSNC.data, mtgJsonSetDMU.data, mtgJsonSetBRO.data, mtgJsonSetONE.data, mtgJsonSetMOM.data, mtgJsonSetMAT.data];
